...
if (isset($_POST['update'])) {
	...
	$q = mysqli_query($link, "UPDATE questions SET q_question='$question', q_answer='$answer', q_mark='$mark', q_level='$level', chapterId = '$chapId', examId = '$exam', subjectId = '$subId' WHERE q_id='$id'");
